...
Also see {{% resource_link "e0192dc3-f775-466c-9ed8-f740a706c7dd" "OpenWetWare: About" %}}.
...
Fill out the form at {{% resource_link "6df46dec-065c-4010-a2a0-3e33368b4311" "how to join" %}} to register for an account on OpenWetWare. You will be sent an email with your account information. Once you have an account, you can login from any webbrowser by clicking the login link at the top right corner of the browser window.
...
Once you have an account, the best way to learn how to edit the wiki is to look at existing pages. Click the "edit" tab at the top of a page to view the "source code" for the page. If you want to play around to see how things appear, you can do that in the {{% resource_link "931e78db-8d3b-4764-8165-d7beae833742" "Sandbox" %}} or even on your own user page.

If you have a question about how encode something in wiki markup language, try googling. There are lots of reference sources out there since OpenWetWare is based on the same software as {{% resource_link "d0a66d5a-0304-4e34-96c3-9d59a194f070" "Wikipedia" %}}. Other reference pages include

*   The {{% resource_link "e5497f72-813e-454d-b214-f74d9429426e" "help page" %}} which shows up in the sidebar of every page.
*   In particular, see {{% resource_link "37ac99b5-fddb-4d91-a9b5-6c57d7e084ed" "Simple wiki editing examples" %}} for a quick how-to on wiki editing.
