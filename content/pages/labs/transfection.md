...
Left to right: Firefly photo courtesy of Eloise Mason ({{% resource_link "1662cd77-6173-4f97-ac5f-db7ae38ca8c0" "Flickr" %}}). Plasmid map. (Courtesy of Promega Corporation. Used with permission.) "Sea pansy" (Renilla reniformis) courtesy of NOAA.
