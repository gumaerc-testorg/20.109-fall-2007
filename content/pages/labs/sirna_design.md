...
Begin by retrieving the sequence of the gene you hope to silence. Open a Web browser program and go to {{% resource_link "987f2825-6a23-4e0a-abd7-095a5a47ee37" "the Promega homepage" %}}. The Renilla luciferase gene was fully sequenced {{% resource_link "59a084a6-a57b-48cb-aa60-7be3bb9834a6" "in 1991" %}} but the clone you will study is expressed on a plasmid that is commercially available from Promega.
...
2. Is the sequence likely to form secondary structures? These might make them difficult to process or unlikely to bind their target mRNA. The easiest predictors of secondary structure are the melting temperature, Tm, of the dsRNA and the free energy of the sequence. Tm can be calculated by pasting the sequence into a Web-program available through {{% resource_link "977ea12c-ffeb-4432-8189-768d0531ea00" "Integrated DNA Technologies" %}}. Be sure the target type is set to RNA. There are several Web-based programs available to predict RNA secondary structure and calculate its free energy. One such program is {{% resource_link "7906222c-5b86-4261-ac05-4ab5dc8a8f26" "here" %}}. Another site to use for comparison is {{% resource_link "2ee3c045-7a0c-419d-a374-e934e617b6c9" "OligoCalc" %}} which will return Tm, G/C content and free energy calculations.
...
1. Ambion does not have the only siRNA design program. Compare the siRNA design criteria used by {{% resource_link "6fa60d35-eb5e-44ab-9668-d50d8d9adb68" "Ambion" %}} to those followed by another life sciences company, Dharmacon, which also specializes in RNAi technology. The {{% resource_link "cbd0d1d3-162a-491a-bd4d-7a6725682c55" "Dharmacon" %}} search algorithm is based on the criteria for their siRNA design rules described by {{% resource_link "119de7e4-c883-4f47-9438-d6bb3b6fb3cd" "Reynolds, et al." %}} in *Nature Biotechnology* 22, no. 3 (2004): 326-330. Decide how your siRNA candidates from the Ambion design algorithm rank using the Dharmacon criteria.
